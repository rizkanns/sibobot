...
class Proyek extends Model
{
    ...
    {
    	return $this->belongsTo('App\Mitra', 'fk_id_mitra', 'id_mitra');
    }

    public function user()
    {
    	return $this->belongsTo('App\User', 'fk_id_users', 'id');
    }

    public function pelanggan()
    {
    	return $this->belongsTo('App\Pelanggan', 'fk_id_pelanggan', 'id_pelanggan');
    }

    public function unit_kerja()
    {
        return $this->belongsTo('App\User', 'fk_id_unit_kerja', 'id_unit_kerja');
    }
