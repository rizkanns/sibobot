...
class AspekBisnis extends Model
{
    ...
    protected $fillable = ['id_proyek','layanan_revenue','beban_mitra','nilai_kontrak','margin_tg','rp_margin','colocation','revenue_connectivity','revenue_cpe_proyek','revenue_cpe_mitra'];
