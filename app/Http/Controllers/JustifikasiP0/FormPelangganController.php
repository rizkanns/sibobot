...
namespace App\Http\Controllers\JustifikasiP0;
...
class FormPelangganController extends Controller
{
	...
	public function indexPelanggan()
	{
		...
		// dd($witel);
		return view('justifikasi_p0.form-pelanggan', ['pelanggan'=>$pelanggan, 'auth'=>$auth, 'proyek'=>$proyek, 'witel'=>$witel]);
	}
    ...
    public function insertPelanggan(Request $request)
    {
		...
		return redirect()->route('p0_proyek_single', ['id_pelanggan'=>$pelanggan->id_pelanggan, 'id_proyek' => $proyek->id_proyek, 'id_aspek' => $aspek->id_aspek, ]);
	...
	public function singlePelanggan($id_pelanggan,$id_proyek,$id_aspek)
    {
		...
		$witel = DB::table('witel')->get();
    	return view('justifikasi_p0.form-pelanggan-update',$data,['witel'=>$witel]);
    }
