...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h1 class="text-center" style="color: #d51100; font-weight: 500;">MITRA</h1><br><br>
                        <div class="col-md-12">
                            @if(session('create'))
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal form-material" action="{{ route('mitra_insert') }}" method = "post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input required type="text" class="form-control" id="inputEmail3" placeholder="Nama Mitra" name="nama_mitra">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                    ...
                    <!-- <div class="table-responsive"> -->
                        <table class="table color-table warning-table example">
                            <thead>
                                <tr>
                                    <th colspan=6>DAFTAR MITRA</th>
                                </tr>
                                <tr>
                                    <th class="text-center" style="background-color: white; color: black;">No.</th>
                                    <th class="text-center" style="background-color: white; color: black; width: 15%;">Nama Mitra</th>
