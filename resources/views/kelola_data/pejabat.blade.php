...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box">
                    <h1 class="text-center" style="color: #d51100; font-weight: 500;">PEJABAT</h1><br><br>
                        <div class="col-md-12">
                            @if(session('create'))
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal form-material" action="{{ route('user_insert') }}" method = "get">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input required type="text" class="form-control" id="inputEmail3" placeholder="Nama Pejabat" name="name">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">NIK</label>
                                                    <div class="col-sm-5">
                                                        <input required  type="text" class="form-control" id="inputEmail3" placeholder="NIK Pejabat" name="nik">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input required type="password" class="form-control" id="inputEmail3" placeholder="Password" name="password">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <label for="inputEmail3" class="col-sm-3 control-label">Jabatan</label>
                                                    <div class="col-sm-4">
                                                       <select required class="selectpicker m-b-20" data-style="form-control" name="id_jabatan">
                    ...
                    <!-- <div class="table-responsive"> -->
                        <table class="table color-table warning-table example">
                            <thead>
                                <tr>
                                    <th colspan=7>DAFTAR PEJABAT</th>
                                </tr>
                                <tr>
                                    <th class="text-center" style="background-color: white; color: black;">No.</th>
                                    <th class="text-center" style="background-color: white; color: black;">Nama</th>
                                    <th class="text-center" style="background-color: white; color: black;">NIK</th>
                                    <th class="text-center" style="background-color: white; color: black;">Email</th>
                                    <th class="text-center" style="background-color: white; color: black;">Jabatan</th>
                            ...
                            <tbody>
                                    ...
                                    <tr class="fuckOffPadding">
                                        ...
                                        <td style="text-align: justify;">
                                            {{-- @foreach($witel->where($listuser->id,$witel->id_witel) as $listwitel) --}}
                                            {{$listuser->nama_witel}}
                                            {{-- @endforeach --}}
                                        </td>
