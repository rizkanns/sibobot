                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material"action="{{ route('p1_aspek_insert', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}" method = "get">
                                {{-- {{ csrf_field() }} --}}
                            ...
                            @endif
                                <div class="form-group m-b-0">
                                    <a href="{{ route('p1_proyek_single', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}"  style="float: left;" class="btn btn-danger waves-effect waves-light m-t-10">Sebelumnya</a>
