                ...
                {{-- {{ $listpelanggan->id_pelanggan }} {{ $listproyek->id_proyek }} {{ $listaspek->id_aspek }} --}}
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <form class="form-horizontal form-material" action="{{ route('p1_pelanggan_update', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}" method = "get">
