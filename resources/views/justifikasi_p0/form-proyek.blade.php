                    ...
                    {{-- {{ $listpelanggan->id_pelanggan }} {{ $listproyek->id_proyek }} {{ $listaspek->id_aspek }}  --}}
                        <div class="col-sm-12">
                            <div class="white-box">
                                ...
                                <form enctype="multipart/form-data" class="form-horizontal form-material" action="{{ route('p0_proyek_insert', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        ...
                                        <div class="row col-sm-12 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <a href="{{ route('p0_file_p0_update', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}"  style="float: left;" class="btn btn-success waves-effect waves-light m-t-10"><i class="fa fa-edit"></i> Ubah</a>
                                                </div>
                                            </div>
                                            @endif
                                    ...
                                    <div class="row form-group m-b-0">
                                        <a href="{{ route('p0_pelanggan_single', ['id_pelanggan' => $listpelanggan->id_pelanggan, 'id_proyek' => $listproyek->id_proyek, 'id_aspek' => $listaspek->id_aspek]) }}"  style="float: left;" class="btn btn-danger waves-effect waves-light m-t-10">Sebelumnya</a>
